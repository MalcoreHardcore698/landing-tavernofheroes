...
$(function(){$(".primary-content .slider .owl-carousel").owlCarousel({items:1,dot:!0,autoplay:!0,mouseDrag:!1,loop:!0}),$("#mobile-menu").mmenu({navbar:{title:'<a href="/" class="logo-st"><img src="/tavernofheroes_reborn/img/logo/ToHLogo3.png" alt="Logo Tavern of Heroes"></a>'},offCanvas:{position:"right"}})});
