...
$(function(){$(".hamburger").click(function(){$(this).addClass("is-active"),$("body").hasClass("shift-page")||($("body").addClass("shift-page"),$(".wrapper").addClass("blackout"),$(".head-menu").animate({right:0}),$("body").animate({right:240})),$(".wrapper").click(function(){$(this).hasClass("blackout")&&($(".wrapper").removeClass("blackout"),$("body").removeClass("shift-page"),$(".hamburger").removeClass("is-active"),$(".head-menu").animate({right:-240}),$("body").animate({right:0}))})}),$(".wrap-blocks .primary-content .owl-carousel").owlCarousel({items:1,dot:!0,autoplay:!0,mouseDrag:!1,loop:!0})});