...
$(function(){var n=$("#my-menu").mmenu(),i=$("#mmenu-icon"),o=n.data("mmenu");i.on("click",function(){o.open()}),o.bind("opened",function(){setTimeout(function(){i.addClass("is-active")},100),i.on("click",function(){o.close()})}),o.bind("closed",function(){setTimeout(function(){i.removeClass("is-active")},100),i.on("click",function(){o.open()})})});